...
## Summary
- 5231 nodes · 8437 edges · 180 communities detected
- Extraction: 75% EXTRACTED · 25% INFERRED · 0% AMBIGUOUS · INFERRED: 2118 edges (avg confidence: 0.5)
...
Cohesion: 0.01
Nodes (126): getCroppedBlob(), handleCropConfirm(), getBadgeInfo(), parseDynamicBadge(), hexifyRgba(), main(), runChecks(), contrastRatio() (+118 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (311): aggregateDefense(), parseInnings(), check(), main(), check(), main(), addDaysIso(), applyRunnerStats() (+303 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (100): getOAuthCallbackUrl(), signInWithApple(), signInWithGoogle(), signInWithKakao(), handleVisibilityChange(), loadProfile(), refreshProfile(), syncProfileToLocal() (+92 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (114): extractTableRow(), parseHitterBasic(), parsePitcherBasic(), safeInt(), check(), installFetch(), main(), sleep() (+106 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (131): inject(), legacyRawFetchTodayGames(), main(), clampOuts(), diamond(), inningLabel(), parseTeamCodes(), pushAndroidWidgetLiveUpdates() (+123 more)

### Community 5 - "Community 5"
Cohesion: 0.01
Nodes (166): ActivityAttributes, AppEntity, AppIntentTimelineProvider, Codable, CodingKey, Decodable, EntityQuery, Hashable (+158 more)

### Community 6 - "Community 6"
Cohesion: 0.01
Nodes (73): appendAttribution(), decodeHtmlEntities(), extractInstagramHandle(), getPlatformLabel(), getThreadsHandle(), hasExistingAttribution(), resolveHandle(), PostLabel() (+65 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (126): buildA1(), buildB(), buildC1(), buildC2(), buildC4(), buildC5(), buildC6(), buildCContext() (+118 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (64): buildDiscoveryQueries(), hasLatinToken(), gatedActivations(), ok(), runFailurePropagationTests(), titleHasTeam(), main(), stubFetch() (+56 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (41): classifyIsPitcher(), findBatter(), findPitcher(), check(), publicFileExists(), decompose(), getChosung(), groupQueryToSyllables() (+33 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (46): AppIntent, isFollowupPhrase(), normalizeFollowup(), ExampleInstrumentedTest, Eff, GameScoreWidgetSmall, cardGradient(), Color (+38 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (54): boxScore(), cells(), json(), main(), pitcher(), scenario(), scoreboard(), main() (+46 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (48): classifyResultMirror(), parseInningRelaysMirror(), getDuration(), isEpic(), isHomerun(), isVictory(), aggregatePitcherNames(), diffBatters() (+40 more)
...
Cohesion: 0.06
Nodes (47): ctxDeps(), eligibleTurn(), freshCtx(), main(), previousTurn(), seedTurn(), setupContextDb(), verifyAcPipeline() (+39 more)
...
Cohesion: 0.06
Nodes (16): main(), read(), buildNewsCommentsUrl(), getInjectedCapacitor(), handleExternalAnchorClick(), handleNewsArticleAnchorClick(), isHttpUrl(), isNativeRuntime() (+8 more)

### Community 24 - "Community 24"
Cohesion: 0.07
Nodes (30): decodeHtmlEntities(), extractAttr(), extractInstagramImageUrls(), extractInstagramImageUrlsFromSrcset(), extractInstagramVideoUrls(), extractMediaList(), extractMlbparkImageUrls(), extractOgMedia() (+22 more)

### Community 25 - "Community 25"
Cohesion: 0.05
Nodes (18): AnyObject, App, CAPBridgedPlugin, CAPBridgeProtocol, CAPPlugin, CAPPluginCall, CAPPluginMethod, KBOWatchApp (+10 more)

### Community 26 - "Community 26"
Cohesion: 0.07
Nodes (7): calcBatterRadar(), calcPitcherRadar(), clamp(), check(), inRange(), toWeeklyTrend(), weekOf()
...
Cohesion: 0.08
Nodes (7): formatDurationBadge(), mediaDurationBadge(), base64ToBytes(), callPlugin(), exportVenueMediaFile(), getInjectedPlugin(), listVenueMedia()

### Community 32 - "Community 32"
Cohesion: 0.15
Nodes (1): GameScoreWidget

### Community 33 - "Community 33"
Cohesion: 0.12
Nodes (19): collectSeasonGameUniverse(), getDatesInMonth(), getMonthGames(), getSeasonDates(), getTtlMs(), backfillContrastRegression(), cacheAndSingleFlightRegression(), completeGamesExactRegression() (+11 more)
...
Cohesion: 0.2
Nodes (2): check(), runSingleFlightRegression()
...
- **Thin community `Community 147`** (2 nodes): `photo-post-qa.spec.ts`, `ensureTestImage()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 148`** (2 nodes): `activate-urgent-notice.ts`, `main()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 149`** (2 nodes): `deactivate-urgent-notice.ts`, `main()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 150`** (2 nodes): `account-deletion-contract-smoke.ts`, `check()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 151`** (2 nodes): `kgwan-refresh-epoch-smoke.ts`, `ok()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 152`** (2 nodes): `mood-gauge-realtime-load-smoke.ts`, `check()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 153`** (2 nodes): `observability-config-smoke.ts`, `extractMetricNames()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 154`** (2 nodes): `photos-helper-signature.ts`, `fail()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 155`** (2 nodes): `rpc-error-contract-smoke.ts`, `check()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 156`** (2 nodes): `share-og-missing-post-smoke.ts`, `main()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 157`** (2 nodes): `visibility-poller-adoption-smoke.ts`, `check()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 158`** (2 nodes): `seed-channel-pool.ts`, `main()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 159`** (2 nodes): `seed-gif-collector-bot.ts`, `main()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 160`** (2 nodes): `seed-jjal-collector-bot.ts`, `main()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 161`** (2 nodes): `robots.ts`, `robots()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 162`** (2 nodes): `StadiumInfo.tsx`, `stadiumId()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 163`** (2 nodes): `StatusBadge.tsx`, `StatusBadge()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 164`** (2 nodes): `awards.ts`, `getPlayerAwards()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 165`** (2 nodes): `leaderboard-exclusions.ts`, `isInternalUser()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 166`** (1 nodes): `capacitor.config.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 167`** (1 nodes): `api.spec.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 168`** (1 nodes): `interaction.spec.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 169`** (1 nodes): `navigation.spec.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 170`** (1 nodes): `Package.swift`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 171`** (1 nodes): `CapApp-SPM.swift`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 172`** (1 nodes): `next.config.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 173`** (1 nodes): `playwright.config.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 174`** (1 nodes): `sw.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 175`** (1 nodes): `standings-widget-games-smoke.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 176`** (1 nodes): `RadioPlayer.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 177`** (1 nodes): `TeamComparisonBar.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 178`** (1 nodes): `player-profiles.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 179`** (1 nodes): `writing-points.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `BaseDiamond` connect `Community 5` to `Community 10`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Are the 161 inferred relationships involving `GET()` (e.g. with `verifyPin()` and `getAccessToken()`) actually correct?**
  _`GET()` has 161 INFERRED edges - model-reasoned connections that need verification._
