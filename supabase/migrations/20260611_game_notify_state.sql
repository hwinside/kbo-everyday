...
-- 종료 알림 슬롯 컬럼(end_away_notified/end_home_notified)은 별도 migration
-- (20260611_game_notify_state_slots.sql)로 분리 — 이 파일은 prod 선적용 상태라
-- 컬럼 추가가 재실행 안 될 수 있음 (삼순 #210 재리뷰 블로커).
