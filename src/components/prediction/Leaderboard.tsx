...
function RankBadge({ rank }: { rank: number }) {
  ...
  return (
    <span className="flex h-8 w-8 items-center justify-center text-base font-bold tabular-nums text-text-secondary">
      {rank}
    </span>
  );
}
  ...
  return (
    <div className="relative">
        ...
        {entries.slice(0, 3).map((entry) => {
          ...
          return (
            <motion.div
              ...
              className={`glass-card overflow-hidden border ${style.border} p-5 text-center ${
      ...
      {myEntry && (
        ...
        >
          <div className="glass-card flex items-center gap-4 border border-accent/20 bg-accent/5 p-4">
