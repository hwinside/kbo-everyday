        ...
        {(() => {
          ...
          return (
            <>
              ...
              />
              <button onClick={handleComment} disabled={!comment.trim() || !user} className="w-9 h-9 rounded-full flex items-center justify-center text-white disabled:opacity-30 transition-opacity bg-accent">
                <Send size={16} />
              </button>
            </>
          );
