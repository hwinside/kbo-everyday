 ...
 */
export default function WriteEntrySheet({ isOpen, onClose, onChoosePhoto, onChooseText }: WriteEntrySheetProps) {
    ...
    <AnimatePresence>
      ...
      >
        ...
        >
          ...
          <div className="px-5 py-4 grid grid-cols-2 gap-3 pb-[calc(1rem+env(safe-area-inset-bottom))]">
            <button
            ...
            >
              ...
              <span className="text-xs text-text-tertiary">이미지·동영상 중심</span>
            </button>
            <button
