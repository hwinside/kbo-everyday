...
export default function GameChat({ gameId, homeTeamId, awayTeamId }: GameChatProps) {
  ...
  // iOS Safari keyboard-aware composer (baseline visualViewport pattern —
  // same as PostDetail). The chat input sits above the TabBar when idle and
  // hugs the keyboard when focused.
