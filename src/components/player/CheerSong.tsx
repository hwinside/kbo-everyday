...
const CHEER_SONGS: Record<string, CheerSongData> = {
  ...
  "오스틴": {
    ...
    youtubeUrl: "https://www.youtube.com/results?search_query=LG+오스틴+응원가",
  },
  "박동원": {
    title: "박동원 응원가",
    lyrics: "박동원~ 박동원~\n우리의 박동원~\n힘차게 날려라~\n박동원~ 박동원~",
  ...
  "고우석": {
    title: "고우석 응원가",
    lyrics: "고우석~ 고우석~\n마지막을 지켜라~\n9회의 수호신~\n고우석~ 고우석~",
    youtubeUrl: "https://www.youtube.com/results?search_query=LG+고우석+응원가",
  },
  "홍창기": {
    title: "홍창기 응원가",
    lyrics: "홍창기~ 홍창기~\n달려라 홍창기~\n1번의 자리를~\n홍창기가 지킨다~",
  ...
  "안우진": {
    title: "안우진 응원가",
    lyrics: "안우진~ 안우진~\n불꽃의 직구로~\n삼진을 잡아라~\n안우진~ 안우진~",
    youtubeUrl: "https://www.youtube.com/results?search_query=KIA+안우진+응원가",
  },
  "최형우": {
    title: "최형우 응원가",
    lyrics: "최형우~ 최형우~\n형이니까 믿는다~\n묵직한 한 방으로~\n최형우~ 최형우~",
    youtubeUrl: "https://www.youtube.com/results?search_query=KIA+최형우+응원가",
  },
  ...
  "문동주": {
    title: "문동주 응원가",
    lyrics: "문동주~ 문동주~\n불꽃의 투수~\n강속구 하나면~\n삼진이 바로~\n문동주~ 문동주~",
    youtubeUrl: "https://www.youtube.com/results?search_query=한화+문동주+응원가",
  },
  "노시환": {
    title: "노시환 응원가",
    lyrics: "노시환~ 노시환~\n대전의 슬러거~\n담장을 넘겨라~\n노시환~ 노시환~",
  ...
  "최정": {
    title: "최정 응원가",
    lyrics: "최정~ 최정~\n홈런왕 최정~\n빠던의 전설~\n담장 너머로~\n최정~ 최정~",
    youtubeUrl: "https://www.youtube.com/results?search_query=SSG+최정+응원가",
  },
  "페르난데스": {
    title: "페르난데스 응원가",
    lyrics: "페르난데스~ 페르난데스~\n삼진을 잡아라~\n마운드의 지배자~\n페르난데스~",
  ...
  "강백호": {
    title: "강백호 응원가",
    lyrics: "강백호~ 강백호~\n위대한 타자~\n힘차게 날려라~\n홈런을 쳐라~\n강백호~ 강백호~",
    youtubeUrl: "https://www.youtube.com/results?search_query=KT+강백호+응원가",
  ...
  "이정후": {
    title: "이정후 응원가",
    lyrics: "이정후~ 이정후~ 짠~\n안타를 쳐라~\n이정후~ 이정후~\n우리의 이정후~",
    youtubeUrl: "https://www.youtube.com/results?search_query=키움+이정후+응원가",
  },
  "이의리": {
    title: "이의리 응원가",
    lyrics: "이의리~ 이의리~\n화끈한 직구~\n삼진을 잡아라~\n이의리~ 이의리~",
  ...
  "나성범": {
    title: "나성범 응원가",
    lyrics: "나성범~ 나성범~\n창원의 자존심~\n강한 어깨와~\n화끈한 타격~\n나성범~ 나성범~",
    youtubeUrl: "https://www.youtube.com/results?search_query=NC+나성범+응원가",
  },
  "소형준": {
    title: "소형준 응원가",
    lyrics: "소형준~ 소형준~\n좌완의 에이스~\n삼진을 잡아라~\n소형준~ 소형준~",
