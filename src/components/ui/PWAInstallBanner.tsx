...
export default function PWAInstallBanner() {
  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-lg px-5 mb-3 animate-fade-in">
        <div className="bg-[rgba(30,30,35,0.95)] backdrop-blur-xl border border-border rounded-2xl px-4 py-2.5 flex items-center gap-3">
