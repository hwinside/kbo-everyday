...
export default function TabBar() {
  ...
  return (
    <nav data-tabbar className="fixed bottom-0 left-0 right-0 z-50 rounded-none border-t border-border bg-[rgba(248,248,250,0.85)] dark:bg-[rgba(10,10,11,0.85)] backdrop-blur-xl">
