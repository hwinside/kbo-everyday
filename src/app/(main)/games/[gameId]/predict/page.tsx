...
export default function GamePredictPage() {
  ...
  return (
    <div className="min-h-screen bg-bg-primary pb-24">
      ...
      <div className="sticky top-0 z-30 border-b border-border bg-bg-primary px-5 flex items-center gap-3 pb-3" style={{ paddingTop: "env(safe-area-inset-top, 0px)", marginTop: "calc(env(safe-area-inset-top, 0px) * -1)" }}>
