    ...
    <div className="min-h-screen bg-bg-primary">
      ...
      <div className="sticky top-0 z-30 border-b border-border bg-bg-primary/80 backdrop-blur-xl px-4 py-3 flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-[11px] text-text-tertiary">게시글 수 기준 인기 선수</p>
        </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="text-[11px] px-1.5 py-0.5 rounded-full" style={{ backgroundColor: getTeamColor(player.teamId) + "20", color: getTeamColor(player.teamId) }}>
