...
const LEGACY_MAP: Record<string, string> = {
  ...
  // 외국인 선수 구형 kboId → 신형 kboId alias
  "56011": "AQ007",  // 스기모토 → 스기모토 고우키
  "56415": "AQ003",  // 미야지 → 미야지 유라
  "56719": "AQ001",  // 왕옌청
  "69045": "FP020",  // 알칸타라 → 라울 알칸타라
  "54730": "FP003",  // 페라자 → 요나단 페라자
  "56632": "AQ004",  // 데일 → 제리드 데일
  "56626": "FP016",  // 카스트로 → 해럴드 카스트로
  "56032": "FP011",  // 사우어 → 맷 사우어
  "56034": "FP013",  // 힐리어드 → 샘 힐리어드
  "56036": "FP012",  // 보쉰리 → 케일럽 보쉰리
  "55348": "AQ002",  // 웰스 → 라클란 웰스
  "55146": "FP004",  // 치리노스 → 요니 치리노스
  "53827": "FP008",  // 에레디아 → 기예르모 에레디아
  "56928": "FP010",  // 버하겐 → 드루 버하겐
  "55855": "FP007",  // 화이트 → 미치 화이트
  "56251": "FP009",  // 카메론 → 다즈 카메론
  "50234": "FP017",  // 플렉센 → 크리스 플렉센
  "56531": "FP014",  // 로드리게스 → 엘빈 로드리게스
  "56523": "FP015",  // 비슬리 → 제러미 비슬리
  "54400": "FP006",  // 디아즈 → 르윈 디아즈
  "56334": "FP019",  // 와일스 → 네이선 와일스
  "56322": "FP018",  // 브룩스 → 트렌턴 브룩스
  "56712": "FP001",  // 에르난데스 → 윈켈 에르난데스
  "56724": "FP002",  // 화이트 → 오웬 화이트
  "56348": "AQ010",  // 유토 → 가나쿠보 유토
  "56911": "AQ006",  // 토다 → 도다 나츠키
};
