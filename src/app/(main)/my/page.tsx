...
export default function MyPage() {
  ...
  return (
    <div className="mx-auto max-w-lg px-5 pb-24">
      ...
      {/* 숏츠 설정 */}
      <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.145 }} className="mt-3">
        <ShortsToggleCard user={user} enabled={profile?.show_shorts !== false} onSaved={refreshProfile} />
      </motion.div>
