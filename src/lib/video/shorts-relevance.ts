...
const SHORTS_BASEBALL_CONTEXT_WEAK = [
  ...
  "분위기",
  "루키",
  // 운영 케이스 79W-OwErIEA `한화 앞에서 선보인 LG의 행복수비` (2026-07-24 삼순
  // 라운드4) — 수비/공격은 야구 숏츠 제목의 상시 어휘인데 어느 목록에도 없어
  // false negative. 파생어(수비드·수비수)는 접미 경계 규칙이 차단한다.
...
const CONTEXT_ALLOWED_SUFFIXES = [
  ...
  "조차",
  "마저",
  "으로", // 자음 종결 체언 조사 (`만루홈런으로` — 2026-07-24 라운드4 전수 재검증)
