...
export const BASEBALL_QA_SYSTEM_PROMPT = [
  ...
  // 리그 통산·역대 순위 (2026-08-10 캡처: `통산 안타 기록 1위는 누구야?`). 정본 조회가
  // 없는 축이라 이름/순위 관계까지만 — 수치는 파이프라인 기계 가드가 한 번 더 막는다.
  "통산·역대 순위 질문(통산 안타 1위 등)은 널리 알려진 선수 이름과 순위 관계만 답하고, 누적 기록 수치는 쓰지 않는다.",
