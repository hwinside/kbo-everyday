...
export const UNTRUSTED_METRIC_ANSWER =
  "그 기록은 아직 정확하게 안내할 수 없습니다. 타율·안타·2루타·홈런·타점 같은 기록은 답변합니다.";
...
export const UNSUPPORTED_SEASON_ANSWER =
  "그 기간 형태로는 아직 집계할 수 없습니다. 특정 연도(예: 2019년 타율), 통산 기록, 연도별 기록은 답변합니다.";
export const RECORD_MISSING_ANSWER =
  "그 선수의 올 시즌 기록을 아직 찾지 못했습니다. 조금 뒤에 다시 물어봐 주십시오.";
