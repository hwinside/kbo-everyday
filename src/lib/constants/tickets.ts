...
export const TICKET_OPEN_RULES: Record<number, TicketOpenRule> = {
  // url = 구단별 예매 페이지 딥링크 (2026-06-19 전수 200 확인). 티켓링크는 m/137/{팀번호}, 나머지는 구단 공식 예매 페이지.
  1:  { daysBefore: 7,  hour: 11, maxTickets: 4,  label: "경기 7일 전 오전 11시 (최대 4매)", provider: "티켓링크", url: "https://m.ticketlink.co.kr/sports/137/59" },
  2:  { daysBefore: 7,  hour: 11, maxTickets: 4,  label: "경기 7일 전 오전 11시 (최대 4매)", provider: "인터파크", url: "https://www.doosanbears.com" },
  3:  { daysBefore: 7,  hour: 16, maxTickets: 8,  label: "경기 7일 전 오후 4시 (최대 8매)", provider: "티켓링크", url: "https://www.ktwiz.co.kr/ticket/reservation" },
  ...
  6:  { daysBefore: 7,  hour: 11, maxTickets: 4,  label: "경기 7일 전 오전 11시 (최대 4매)", provider: "티켓링크", url: "https://tigers.co.kr/ticket/reservation" },
  ...
  9:  { daysBefore: 7,  hour: 11, maxTickets: 4,  label: "경기 7일 전 오전 11시 (최대 4매)", provider: "티켓링크", url: "https://www.hanwhaeagles.co.kr" },
