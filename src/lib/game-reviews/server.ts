...
const errors: Record<string, [string, number]> = {
  ...
  gr_player_required: ["승리팀 출전 수훈선수 1명을 선택해 주세요. 선수 정보를 불러오지 못했다면 다시 시도해 주세요", 400],
  gr_nomination_disabled: ["현재 수훈선수 지정은 사용하지 않아요", 400],
  gr_exists: ["이 경기에는 이미 한 줄을 남겼어요. 현재 작성 가능 상태를 새로고침해 주세요", 409],
