...
- Add a Cloudflare Worker webhook receiver with authentication, replay protection, incident deduplication, Slack delivery, and Telegram delivery.
...
- Install the managed Supabase integration in Grafana Cloud using a Supabase Secret API key.
...
- Delete or disable the Cloudflare Worker route and its incident KV namespace.
