...
// 기대값 (스펙 §3.1)
// ============================================================================
const EXPECTED_COUNT = 879; // 2026-07-28: 신규 외인 보스(56402) 온보딩(+1=878). 이력: PR #871 짐머만(56799) 등록(+1=877), 07-21 쿄야마(AQ008) stale 중복 통합, 07-20 Player/Search.aspx 전수 dry-run 미출전/퓨처스 33명 1회 백필(876).
