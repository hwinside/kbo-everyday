...
// 기대값 (스펙 §3.1)
// ============================================================================
const EXPECTED_COUNT = 836; // 2026-07-14: 정대선(롯데/53568)·이준서(롯데/56554) 수동 온보딩 — 상무 전역 복귀/신인 1군 등록, 기록순위 기반 크롤러 미포착분 (CS 김영웅 홈런 불일치 규명 중 동시 발견) + 정은원(68743) 사진 갭 보강. 이전 834: 2026-07-09 정은원(한화/68743). 833: 2026-07-05 김현준/박건우[롯데]/정민규/블레인 콜업 온보딩
