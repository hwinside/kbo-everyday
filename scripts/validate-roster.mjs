...
// 기대값 (스펙 §3.1)
// ============================================================================
const EXPECTED_COUNT = 843; // 2026-07-19: 조요한(SSG/51809, 국내 투수 No.98, 상무 복무로 2026 미출전 → 기존 크롤 미포착, CS 제보 수동 온보딩). 842: #683(auto 2026-07-18) 세베리노(두산/56236)·아빌라(SSG/56801)·엄준현(KIA/55631) + #695 페덱(삼성/FP024) 온보딩 반영(#700 리뷰서 baseline 미동기화 발견). 838: 2026-07-15 #643(auto reconcile 2026-07-14) 자동 온보딩 김성민(키움/67828) — baseline 미동기화분(PR #668 리뷰서 발견). 837: 2026-07-14 김성진(LG/69105, 69105/51301 동명이인) — validate-player-identity false-PASS blocker 수정으로 드러난 미등록분. 그 직전 836: 정대선(롯데/53568)·이준서(롯데/56554) 수동 온보딩 + 정은원(68743) 사진 갭 보강. 834: 2026-07-09 정은원(한화/68743). 833: 2026-07-05 김현준/박건우[롯데]/정민규/블레인 콜업 온보딩
