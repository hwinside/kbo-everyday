...
// 기대값 (스펙 §3.1)
// ============================================================================
const EXPECTED_COUNT = 837; // 2026-07-14: reconcile-roster-from-stats 자동 온보딩 김성진(LG/69105, 69105/51301 동명이인) — validate-player-identity false-PASS blocker 수정으로 드러난 미등록분. 그 직전 836: 정대선(롯데/53568)·이준서(롯데/56554) 수동 온보딩 + 정은원(68743) 사진 갭 보강. 834: 2026-07-09 정은원(한화/68743). 833: 2026-07-05 김현준/박건우[롯데]/정민규/블레인 콜업 온보딩
