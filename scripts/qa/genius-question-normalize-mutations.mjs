...
const mutations = [
  ...
  },
  {
    ...
    find: "digitSequencesMatch(question, candidate) &&",
    replace: "true &&",
  },
  {
    name: "M3 재라우팅 blocked 가드 제거",
    find: 'routeQuestion(candidate, glossary, players, false) !== "blocked"',
    replace: "true",
  },
  {
    name: "M4 실변경(raw 비교) 가드 제거",
    find: "candidate !== question &&",
    replace: "true &&",
  },
  {
  ...
  {
    name: "M7 길이 상한 가드 제거",
    find: "candidate.length <= question.length * 2 + 10 &&",
    replace: "true &&",
  },
];
