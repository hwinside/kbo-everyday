...
const MUTATIONS = [
  ...
  },
  {
    ...
    file: PIPELINE,
    from: "  const route = (statDefinition || enabledPlayerCandidate || (reportedTermUsage && baseRoute !== \"blocked\"))",
    to: "  const route = (statDefinition || (reportedTermUsage && baseRoute !== \"blocked\"))",
  },
  {
