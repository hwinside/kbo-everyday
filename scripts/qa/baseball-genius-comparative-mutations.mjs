...
const MUTATIONS = [
  ...
  },
  {
    ...
    file: PIPELINE,
    anchor: "llm = await deps.callLlm(question, context ?? undefined, rosterBlock, statNumericGuard && !statDefinition && !reportedTermUsage, statDefinition ?? undefined);",
    replacement: "llm = await deps.callLlm(question, undefined, rosterBlock, statNumericGuard && !statDefinition && !reportedTermUsage, statDefinition ?? undefined);",
